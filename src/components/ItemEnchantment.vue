<template>
  ...
  >
    <div class="flex items-center gap-2">
      ...
      <div class="text-primary-light">{{ enchantment?.name }}</div>
    </div>

    <div class="text-primary-light">{{ enchantment?.rate }}%</div>
  </div>

  <div
    v-if="enchantment?.type == 'Epic'"
